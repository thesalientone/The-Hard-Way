    ...
    def play(self):
        ...
        while current_scene != last_scene:
            ...
            if next_scene_name in ['menu', 'inv', 'save', 'equip',
                ...
                if prev_scene not in [self.scene_map.towns, 'start', 'menu'] and next_scene_name not in [self.scene_map.towns, 'start']:
...
>"""
    ...
    def act(self, target_list):
        ...
        if action in ['1', 'attack', 'Attack', 'a', 'A']:
            damage, target, dtype = self.attack(target_list)

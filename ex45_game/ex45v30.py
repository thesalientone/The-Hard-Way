...
ironhelm = Equipment('Iron Helm', 0, 0, 15, 7, 0 , 0, 150)
        ...
        try:
            if class_name == "Item":
                if item_number:
                    ...
                    print self.item_dictionary[item_list[int(item_number) -1][1]].__class__.__name__
...
class Opening(Scene):
    ...
    Press 3 to add Iron Helm for testing
    """

...
ether = Item('Ether', 0, 20, 'Restores 200 MP', 'p')
hipotion = Item('Hi-Potion', 500, 0, 'Restores 500 HP', 'p')
hiether = Item('Hi-Ether', 0, 500, 'Restores 200 MP', 'p')
...
class Hero(object):
    ...
    def set_stats(self, lev, exp, mag, mdef, stre, defe, hp , mp, speed):
        self.lev = lev
        self.exp = exp
        self.mag = mag
        self.mdef = mdef
...
class Warrior(Hero):
    ...
    def initialize_equipment(self):
        ...
        self.set_stats(1, 0, 5, 6, 9, 8, 100, 5, 10)
...
class WhiteMage(Hero):
    ...
    def initialize_equipment(self):
        ...
        self.set_stats(1, 0, 10, 7, 1, 3, 60, 60, 10)
...
class Theif(Hero):
    ...
    def initialize_equipment(self):
        ...
        self.equip(bronzehelm, 'helm')
        self.equip(bronzechestplate, 'chest')
        self.set_stats(1, 0, 5, 6, 7, 8, 80, 5, 12)
...
class Inventory(object):
    ...
    def select_item(self, item_list):
        ...
        try:
            if item_number:
                ...
                print self.item_dictionary[item_list[int(item_number) -1][1]].desc
                return item_number, self.item_dictionary[item_list[int(item_number)-1][1]]
    ...
    def use_item(self, item):
        ...
        print members[int(hero_number)  - 1].name
...
class InventoryMenu(SubMenu):
    ...
    def enter(self, scene_name):
        ...
        item_list = PARTY.inv.display_items()
